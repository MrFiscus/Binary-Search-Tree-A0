...
2. Includes additional operations like taversal(inorder, preorder, and post order)
3. Checks if the BST is balanced or not
4. Finds the height of a given node
5. Detection when the BST has reached a worst case configuration.
